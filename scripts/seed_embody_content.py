...
def main() -> None:  # noqa: C901
    ...
    try:
        ...
        space.about_content = (
            ...
            "Each term runs for 10 weeks, with three sessions offered each week. Members book the sessions that suit their rhythm, capacity, and season.\n\n"
            "## ✨ Who it's for\n\n"
            "EMBODY is for women who:\n\n"
            "* Feel disconnected from their body, strength, or energy\n"
            "* Are done with punishing fitness culture and want something that actually feels good\n"
            "* Want structure without rigidity — a real container, not just casual classes\n"
            "* Are navigating stress, midlife, peri-menopause, burnout, or big life transitions\n"
            "* Want to feel stronger, steadier, softer, and more connected\n"
            "* Are ready to move, feel, breathe, and be witnessed\n\n"
            "You do not need to be fit. You do not need experience. You just need to be willing to show up.\n\n"
            "## 🔥 What happens in a session\n\n"
            "Each 60-minute session moves through:\n\n"
            "* **Activation** — waking up the body, breath, and awareness\n"
            "* **Breath** — using breath to regulate, energise, and reconnect\n"
            "* **Strength** — functional movement patterns, resistance, and power\n"
            "* **Decompression** — floor-based release, somatic discharge, and regulation\n"
            ...
            "**Location:** South Croydon, Victoria.\n"
            "The private address is shared after enrolment and booking confirmation.\n\n"
            "## 💫 Membership and access\n\n"
            "Joining the EMBODY collective is free. This gives you access to the About page, shared resources, public session information, and community updates.\n\n"
            "Access to the **EMBODY In-Person Sessions** pathway — and the ability to book live sessions — requires term enrolment.\n\n"
            "Term options are:\n\n"
            "* **Awaken** — 1 session per week\n"
            "* **Activate** — 2 sessions per week\n"
            "* **Empower** — 3 sessions per week\n\n"
            "Choose the rhythm that suits your season. The deeper practice is not about doing more for the sake of it — it is about showing up consistently in a way your body can actually receive.\n\n"
            "## 🧺 What to bring\n\n"
            "Please bring:\n\n"
            "* A water bottle\n"
            "* Comfortable, layered clothing you can move in\n"
            "* A mat if you prefer your own\n"
            "* An open mind and a willingness to feel\n\n"
            "Mats are available if you need one.\n\n"
            "## 🔁 Make-up sessions\n\n"
            "If you miss a session, you may attend another session during the term where space allows.\n\n"
            "Make-up sessions are subject to capacity and are managed manually for now.\n\n"
            "## 🦋 Meet your facilitator\n\n"
            "EMBODY is led by Lindsey Hilliard — movement facilitator, somatic practitioner, founder of Fresh Collective, and creator of The Natural Leader.\n\n"
            "Lindsey has spent years exploring the intersection of strength, nervous system safety, feminine embodiment, leadership, and personal transformation. EMBODY brings that work into a weekly practice that is real, grounded, and built for actual women's lives."
        )
