          ...
          {session ? (
            <>
              ...
              <form action={logout}>
                <button
                  type="submit"
                  className="inline-flex items-center justify-center rounded-lg border border-navy-300 px-4 py-2 text-sm font-medium text-navy-700 transition-colors duration-200 hover:border-navy-500 hover:bg-navy-50"
                >
                  Log out
                </button>
              </form>
