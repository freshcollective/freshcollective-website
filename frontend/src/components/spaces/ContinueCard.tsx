...
export default function ContinueCard({
  ...
  return (
    <Link
      href={href}
      className="group block rounded-xl border border-border bg-surface px-7 py-6 transition-shadow hover:shadow-[var(--fc-shadow-raised)]"
    ...
    >
      <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex-1 min-w-0">
          ...
          {stepCount > 0 && (
            <div className="mt-3">
              ...
              <div className="h-1 w-48 max-w-full overflow-hidden rounded-full bg-navy-100">
                <div
        ...
        <div className="shrink-0">
          <span className="inline-flex items-center gap-1.5 rounded-full bg-teal-500 px-5 py-2 text-sm font-medium text-white transition-colors group-hover:bg-teal-600">
            {cta}
            <span>→</span>
          </span>
        </div>
