  ...
  return (
    <Link
      ...
      className={[
        ...
        muted
          ? 'border-border text-black hover:border-slate-300 hover:text-navy-700'
    ...
    <div className="mx-auto max-w-4xl px-6 py-12 md:px-10">
      <div className="mb-10 flex items-start justify-between gap-6">
        ...
        <Link
          ...
          className="shrink-0 rounded-full border border-navy-200 px-4 py-2 text-[13px] font-medium text-navy-700 transition-colors hover:border-navy-400 hover:bg-navy-50"
        >
      ...
      {spaces.length === 0 ? (
        <div className="rounded-xl border border-border bg-surface px-8 py-10 text-center">
          ...
          <p className="mt-2 text-sm text-black">Spaces are created by the platform administrator.</p>
        </div>
      ) : (
            ...
            <div key={space.id} className="rounded-xl border border-border bg-surface px-6 py-5">
              <div className="mb-4 flex items-start justify-between gap-4">
                <div>
                  ...
                  {space.tagline && <p className="text-sm text-black">{space.tagline}</p>}
                </div>
                <Link
              ...
              <div className="flex flex-wrap gap-2">
                ...
                <StudioLink href={`/creator/spaces/${space.slug}/community`} label="Conversations" />
