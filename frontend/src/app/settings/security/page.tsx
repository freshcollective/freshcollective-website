    ...
    <div>
      ...
      <section>
        ...
        <div className="rounded-xl border border-border bg-surface px-6 py-5">
          ...
          <LogoutButton className="rounded-lg border border-slate-200 px-5 py-2.5 text-sm font-medium text-black transition-colors hover:border-slate-300 hover:bg-slate-50" />
        </div>
      </section>
    </div>
  )
